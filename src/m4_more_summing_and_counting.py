...
def run_test_count_cosines_from():
    ...
    # Test 3:
    expected = 2
    answer = count_cosines_from(1, 5, 0.25)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    # Test 4:
    expected = 2
    answer = count_cosines_from(10, 15, 0.75)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    # Test 5:
    expected = 3
    answer = count_cosines_from(1, 6, 0.33)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 3
    answer = count_cosines_from(12, 20, 0.67)
